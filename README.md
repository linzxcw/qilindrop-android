...
**Snapdrop for Android** is an android client for the free and open source local file sharing solution https://qilindrop.cn/. 
...
- And for sure, Snapdrop directly inside the browser - just use it everywhere: https://qilindrop.cn/
